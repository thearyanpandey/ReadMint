            ...
            {uiPhase === 'input' && (
              <div className="max-w-2xl w-full text-center space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-700">
                <div className="space-y-6">
                  ...
                  <h1 className="text-5xl sm:text-7xl font-bold tracking-tight text-[var(--color-text-main)] min-h-[1.5em] flex items-center justify-center">
                    <TypewriterText text="Generate Your" delay={0.1} speed={0.06} className="mr-4" />
                    <span className="text-[var(--color-primary)]">README</span>
                  </h1>
                        ...
                        components={{
                          code({ node, inline, className, children, ...props }) {
                            ...
                            return !inline && match ? (
                              ...
                              <code className={`${className} bg-slate-200 text-slate-800 px-1.5 py-0.5 rounded text-sm font-mono`} {...props}>
                                {children}
                              </code>
                            )
                          },
